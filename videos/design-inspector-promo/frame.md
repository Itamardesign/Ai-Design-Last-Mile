...
colors:
  ...
  text-muted: "#3b82f6"
  text-light: "#9A9A9A"
  accent-light: "rgba(124, 60, 255, 0.08)"
  accent-medium: "rgba(124, 60, 255, 0.15)"
  border: "rgba(124, 60, 255, 0.2)"
  card-bg: "rgba(124, 60, 255, 0.04)"
  positive: "#059669"
  negative: "#dc2626"
...
- **Fonts** — already set to **Inter** (display) / **SFMono-Regular** (body); ignore any preset font name lingering in prose.
